...
import { featuresData } from "./DataFeature";
        ...
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
                {featuresData.map((feature, index) => (
                    <motion.div 
                        key={index} 
                        className={`${index === 1 ? 'p-px rounded-[13px] bg-gradient-to-br from-[#315f7d] to-slate-800' : ''}`}
                        initial={{ y: 150, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
                        viewport={{ once: true }}
                        transition={{ delay: `${index * 0.15}`, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
                    >
                        <div className="p-6 rounded-xl space-y-4 border border-[#315f7d] bg-slate-950 max-w-80 w-full">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                {/* Steel Blue blurred background */}
                <div className="absolute -z-50 size-100 -top-10 -left-20 aspect-square rounded-full bg-[#63a0d4]/40 blur-3xl"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <a 
                            ...
                            className="group flex items-center gap-2 mt-4 text-[#4682B4] hover:text-[#315f7d] transition"
                        >
