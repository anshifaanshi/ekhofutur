    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-transparent">
        <div className="flex items-center justify-between px-8 py-6">
            ...
            {/* mix-blend-screen removes the black background of an image */}
            {/* mix-blend-multiply removes the white background of an image */}
            <img 
              src="https://i.postimg.cc/T2J3XnZb/TRANSPARENT.png" 
